...
This version correctly identifies the containers in the new HTML and contains the definitive, correct logic for the price calculations.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const topControls = document.getElementById('topControls'); // Container for lang/dark buttons
    const langControls = document.getElementById('langControls'); // Sub-container for lang buttons
    ...
    function loadProductsFromExcel(jsonData) { 
        ...
        // THIS IS THE FINAL, CORRECTED LOGIC FOR PRICE CHANNEL SELECTION
